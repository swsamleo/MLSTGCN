...
data_fp = os.path.join(data_dir, 'parking_2month.csv')
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="data/temporal_data\parking", help="Output directory.")
    parser.add_argument("--traffic_df_filename", type=str, default="data/original_data/parking_2month.csv", help="Raw traffic readings.",)
